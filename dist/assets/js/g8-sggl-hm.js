...
$(document).ready(function () {
	...
	if ($('.g8sggl-ps').length) {
		...
		$('head').append('<style type="text/css">.g8sggl-ps *{box-sizing:border-box;-webkit-box-sizing:border-box;-moz-box-sizing:border-box}.g8sggl-ps{padding:10px 0 15px}.g8sggl-ps .g8sggl-ps-t{position:relative;margin:5px}.g8sggl-ps .g8sggl-ps-t .tt{color:#fff;font-weight:700;font-size:18px}.g8sggl-ps .g8sggl-ps-t .rr{position:absolute;right:0;top:5px}.g8sggl-ps .g8sggl-ps-t .rr a{background-color:#d9b300;color:#352c02;text-transform:uppercase;font-size:12px;font-weight:700;padding:5px 10px;border-radius:20px}.g8sggl-ps .g8sggl-ps-t .rr a:hover{background-color:#222;color:#fff}.g8sggl-ps .glbox{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));grid-auto-flow:row;gap:.5rem}.g8sggl-ps .glbox .gl{display:none;width:100%;font-size:12px;padding:5px}.g8sggl-ps .glbox .gl:nth-child(-n+8){display:inline-block}.g8sggl-ps .glbox .gl .glimg{position:relative;width:100%;padding-top:100%;background-color:#050505;cursor:pointer;overflow:hidden}.g8sggl-ps .glbox .gl .gltext{background-color:#5e18be;color:#f0f0f0;padding:6px 10px;text-align:center;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.g8sggl-ps .glbox .gl .glimg:hover .hwrap{opacity:1}.g8sggl-ps .glbox .gl .glpic{position:absolute;width:100%;top:50%;transform:translateY(-50%);z-index:1}.g8sggl-ps .glbox .gl .glpic img{width:100%}.g8sggl-ps .glbox .gl .hwrap{position:absolute;top:0;left:0;width:100%;height:100%;z-index:3;background:rgba(0,0,0,.8);opacity:0}.g8sggl-ps .glbox .gl .hwrap .hbox{position:absolute;width:80%;left:50%;top:50%;transform:translate(-50%,-50%)}.g8sggl-ps .glbox .gl .hwrap .hbox .main{color:#f0f0f0;background-color:#842aff;text-align:center;width:100%;display:block;text-transform:uppercase;padding:8px;border-radius:20px}@media only screen and (min-width:640px){.g8sggl-ps .glbox{grid-template-columns:repeat(5,minmax(0,1fr))}.g8sggl-ps .glbox .gl{display:none!important}.g8sggl-ps .glbox .gl:nth-child(-n+10){display:inline-block!important}}.g8sggl-ps.ss1 .g8sggl-ps-t .tt{color:#212121}\
			\
		</style > ')

		$('.g8sggl-ps').append('<div class="g8sggl-ps-b"><div class="glbox"></div></div>');
